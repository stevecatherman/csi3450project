...
class Employee(models.Model):
    ...
    jobid = models.ForeignKey('Jobtype', models.DO_NOTHING, db_column='jobid')
...
class Paycheck(models.Model):
    ...
    empid = models.ForeignKey('Timecard', models.DO_NOTHING, db_column='empid')
    jobid = models.ForeignKey('Timecard', models.DO_NOTHING, db_column='jobid')
    payid = models.ForeignKey('Timecard', models.DO_NOTHING, db_column='payid')
...
class Timecard(models.Model):
    ...
    jobid = models.ForeignKey(Employee, models.DO_NOTHING, db_column='jobid')
    payid = models.ForeignKey(Payperiod, models.DO_NOTHING, db_column='payid')
